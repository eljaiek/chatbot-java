package com.github.eljaiek.playground.chatbot.views.main;

import java.util.ArrayList;
import java.util.List;
import java.util.Optional;

import com.github.eljaiek.playground.chatbot.views.chat.ChatView;
...
@PWA(name = "chatbot-java", shortName = "chatbot-java")
